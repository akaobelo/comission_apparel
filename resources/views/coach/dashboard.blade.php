                                                                ...
                                                                <div class="flex items-start gap-4">
                                                                    ...
                                                                    <div class="w-16 h-16 bg-slate-100 rounded-lg overflow-hidden border border-slate-200 flex-shrink-0 flex items-center justify-center">
                                                                        @if(!empty($design->image_paths))
                                                                            <img src="{{ Str::startsWith($design->image_paths[0], 'http') || Str::startsWith($design->image_paths[0], '/storage') ? asset($design->image_paths[0]) : asset('storage/' . $design->image_paths[0]) }}" alt="{{ $design->name }}" class="w-full h-full object-cover">
                                                                        @else
